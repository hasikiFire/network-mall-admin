...
CREATE TABLE `package_item` (
  ...
  `device_limit` tinyint DEFAULT NULL COMMENT '设备数量限制',
...
CREATE TABLE pay_order_item (
  ...
  device_limit tinyint COMMENT '在线设备数量限额',
...
CREATE TABLE `foreign_server` (
  ...
  `consumed_data_transfer` bigint unsigned NOT NULL COMMENT '服务器已消耗的流量（单位：B）',
